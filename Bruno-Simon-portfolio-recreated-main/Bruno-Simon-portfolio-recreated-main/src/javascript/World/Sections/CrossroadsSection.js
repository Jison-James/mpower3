...
export default class CrossroadsSection {
    ...
    setStatic() {
        ...
        // Remove Projects Sign
        this.resources.items.crossroadsStaticBase.scene.traverse((_child) => {
            if (_child.name && (_child.name.toLowerCase().includes('projects') || _child.name.toLowerCase().includes('sign'))) {
